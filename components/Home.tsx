...
const Home = () => {
  ...
  const getBalance = async () => {
    try {
      ...
      if (balance.data.$numberDecimal >= 0.0) {
    ...
    <View
        ...
        <TouchableOpacity
          ...
          <View
            ...
            <Icon
              ...
              size={20}
              color={'#fff'}
              style={colorScheme == 'dark' ? {color: '#FFF'} : {color: '#fff'}}
            />
          </View>
        </TouchableOpacity>
      </View>
      <ScrollView>
        ...
        <View style={{flex: 1, marginVertical: 5}}>
          <Text
            style={[
              colorScheme == 'dark' ? {color: '#aaa'} : {color: '#000'},
              {
                fontFamily: 'InterTight-Black',
                fontSize: 16,
                marginLeft: 15,
        ...
        <View style={{flex: 1}}>
          <View
            ...
            <Text
              style={[
                colorScheme == 'dark' ? {color: '#aaa'} : {color: '#000'},
                {fontFamily: 'InterTight-Black', fontSize: 16, marginLeft: 15},
              ]}>
          ...
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
            <TournamentCard
              ...
              entryFee={20}
              startDate={new Date(2024, 4, 10, 12, 0)}></TournamentCard>
            <TournamentCard
              name={'Tech Tactics'}
              entryFee={10}
              startDate={new Date(2024, 4, 10, 12, 0)}></TournamentCard>
    ...
    />*/}
      ...
      <View>
        ...
        {searchingForMatch === false && (
          <TouchableOpacity
            onPress={() => handleEnterMatchmaking(value, value2)}
            style={{
              height: 80,
              marginBottom: 100,
              marginHorizontal: 15,
