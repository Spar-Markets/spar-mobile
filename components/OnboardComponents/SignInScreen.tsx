    ...
    >
      <View style={{flexGrow: 1}}>
        <View style={styles.container}>
          ...
          <View style={[styles.inputContainer, isEmailFocused && {borderColor: theme.colors.accent}]}>
          ...
          <View style={[styles.inputContainer, isPasswordFocused && {borderColor: theme.colors.accent}]}>
