...
const StockOrder = (props: any) => {
  ...
  const handlePress = (value: string) => {
    ...
    if (shareQuantity.includes('.') && shareQuantity.split('.')[1].length >= 6) {
      return;
    }
  ...
  const estimatedCost = (marketPrice * parseFloat(shareQuantity)).toLocaleString(undefined, { 
    ...
    <View style={styles.container}>
      ...
      <View style={{ marginHorizontal: 20 }}>
        <View style={{ flexDirection: 'row', marginVertical: 20 }}>
          ...
          <View style={{ flex: 1 }}></View>
          <Text style={styles.orderFieldText}>${marketPrice}</Text>
        </View>
        <View style={{ height: 1, backgroundColor: theme.colors.primary }}></View>
      </View>
      <View style={{ marginHorizontal: 20 }}>
        ...
        <View>
          <View style={styles.row}>
            ...
            <TouchableOpacity
              ...
              <Text style={[styles.buttonText, { textAlign: 'center' }]}>2</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
          ...
          <View style={styles.row}>
            ...
            <TouchableOpacity
              ...
              <Text style={[styles.buttonText, { textAlign: 'center' }]}>5</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
          ...
          <View style={styles.row}>
            ...
            <TouchableOpacity
              ...
              <Text style={[styles.buttonText, { textAlign: 'center' }]}>8</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
