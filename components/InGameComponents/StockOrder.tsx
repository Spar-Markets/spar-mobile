...
const StockOrder = (props: any) => {
  ...
  const [stockPrice, setPrice] = useState(190.0);
    ...
    <View
      ...
      <View style={{marginTop: statusBarHeight + 10, marginHorizontal: 15}}>
        <View style={{flexDirection: 'row'}}>
          ...
          <View
            ...
            <Text
              style={[
                colorScheme == 'dark' ? {color: '#1ae79c'} : {color: '#000'},
                {
                  marginHorizontal: 15,
                  fontFamily: 'InterTight-Bold',
                  fontSize: 16,
      ...
      <View style={{marginTop: 50, justifyContent: 'center'}}>
        <View
          ...
          <Text
            style={[
              colorScheme == 'dark' ? {color: '#aaa'} : {color: '#aaa'},
              {fontSize: 20, fontFamily: 'InterTight-Black'},
            ]}>
            Shares
          </Text>
