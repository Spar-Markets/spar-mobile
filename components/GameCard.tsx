...
const GameCard = (props:any) => {
    ...
    return (
        <TouchableOpacity style={[colorScheme == 'dark' ? {backgroundColor: '#292929'} : {backgroundColor: '#fff'}, {marginTop: 15, height: 100, marginHorizontal: 12, borderRadius: 12, marginBottom: 12, flexDirection: 'row'}]}>
